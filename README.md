...
- [ ] **SDK Backend Integration** (In Progress) - See [SDK Backend Proposal](./docs/sdk_backend_proposal.md)
- [ ] LLM-based Intent Classification
- [ ] Multi-platform support (Discord, Email)

## 📚 Documentation

- [Development Plan](./docs/DEVELOPMENT_PLAN.md) - Comprehensive roadmap and contribution guide
- [SDK Backend Integration Proposal](./docs/sdk_backend_proposal.md) - Technical design for SDK backend connector

## 🤝 Contributing

We welcome contributions! Please see our [Development Plan](./docs/DEVELOPMENT_PLAN.md) for:
